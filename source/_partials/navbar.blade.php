        ...
        <div class="flex h-16 justify-between">
            ...
            -->
                ...
                <div class="flex flex-shrink-0 items-center">
                    <img class="h-8 w-auto mr-4" src="../assets/images/Copilot.png" alt="Copilot Managed Services">
                    <span class="font-serif text-3xl uppercase text-bold tracking-widest text-gray-900">Copilot</span>
                </div>
            ...
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <button type="button"
                        class="relative inline-flex items-center gap-x-1.5 rounded-md bg-cp_green px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-cp_lightblue focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
